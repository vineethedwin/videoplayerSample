...
public class newVideoPlayerActivity extends Activity implements SurfaceHolder.Callback, MediaPlayer.OnPreparedListener, VideoControllerView.MediaPlayerControl {

    SurfaceView videoSurface;
 public static MediaPlayer player;
    VideoControllerView controller;

    public void landscape(View v){
    	
    	
    	Intent i=new Intent(newVideoPlayerActivity.this,SuccessActivity.class);
    	startActivity(i);
